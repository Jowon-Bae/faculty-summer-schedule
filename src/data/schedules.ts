...
export const SCHEDULES: Schedule[] = [
  ...
  { id: 'r6', type: '기타 사역', startDate: '2026-07-06', endDate: '2026-07-11', participants: ['24', '3'], location: '백두산 여행' },
  ...
  { id: 'c2_2', type: '캠프', startDate: '2026-07-24', endDate: '2026-07-26', participants: ['17', '6', '20', '5'], location: '드림틴즈', customLabel: '문현철, 최광식, 모한샘, 천혜진(7.24-25)' },
